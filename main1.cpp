...
public:
    ...
    Computer assembleFastComputer(ComputerBuilder& builder) {
...
int main() {
    ...
    Computer fastDesktop = assembler.assembleFastComputer(desktopBuilder);
    std::cout << "\nFast Desktop Computer Configuration:" << std::endl;
    fastDesktop.display();
